 ...
 * generated in the orgg.chibamu.takeaways.order.domain package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: orgg.chibamu.takeaways.order.domain
     * 
     */
